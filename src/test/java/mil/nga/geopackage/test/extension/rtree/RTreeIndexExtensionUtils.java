...
public class RTreeIndexExtensionUtils {
	...
	public static void testRTree(GeoPackage geoPackage) throws SQLException {
		...
		for (String featureTable : featureTables) {
			...
			UserCustomResultSet resultSet = tableDao.queryForAll();
			while (resultSet.moveToNext()) {

				RTreeIndexTableRow row = tableDao.getRow(resultSet);
				...
				if (envelope != null) {
					...
					UserCustomResultSet results = tableDao.query(envelope);
			...
			UserCustomResultSet results = tableDao.query(totalEnvelope);
