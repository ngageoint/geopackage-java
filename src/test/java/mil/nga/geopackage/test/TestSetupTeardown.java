...
public class TestSetupTeardown {
	...
	public static GeoPackage setUpImport(File directory) {
		...
		GeoPackage geoPackage = GeoPackageManager
				.open(copyImportDbFile(directory));
		if (geoPackage == null) {
			throw new GeoPackageException("Failed to open database");
		}
	 ...
	 * @return
	 */
	public static GeoPackage setUpImportElevationTiles(File directory) {
	 ...
	 * @return
	 */
	private static File copyImportElevationTilesDbFile(File directory) {
	...
	/**
	 * Tear down the import elevation database
	 * 
	 * @param geoPackage
	 */
	public static void tearDownImportElevationTiles(GeoPackage geoPackage) {
