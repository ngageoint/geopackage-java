...
public class DGIWGGeoPackageManager {
	 ...
	 * @return created file
	 */
	public static GeoPackageFile create(File directory, GeoPackageFileName fileName) {
	 ...
	 * @return
	 */
	private static GeoPackageFile createFile(File file, GeoPackageFileName fileName,
			boolean validate) {
