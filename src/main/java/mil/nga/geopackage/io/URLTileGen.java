...
public class URLTileGen {
	 ...
	 * Tile progress
	 */
	private static TileProgress progress = new TileProgress(LOG_TILE_FREQUENCY);
	...
	private static void printUsage() {
		...
		System.out
				.println("\t\tURL with subsitution variables for requesting tiles");
		System.out.println();
		System.out.println("\t\t{z}");
		System.out.println("\t\t\tz URL subsitution variable for zoom level");
		System.out.println();
		System.out.println("\t\t{x}");
		System.out.println("\t\t\tx URL subsitution variable");
		System.out.println();
		System.out.println("\t\t{y}");
		System.out.println("\t\t\ty URL subsitution variable");
		System.out.println();
		System.out.println("\t\t{minLon}");
		System.out.println("\t\t\tMinimum longitude URL subsitution variable");
		System.out.println();
		System.out.println("\t\t{minLat}");
		System.out.println("\t\t\tMinimum latitude URL subsitution variable");
		System.out.println();
		System.out.println("\t\t{maxLon}");
		System.out.println("\t\t\tMaximum longitude URL subsitution variable");
		System.out.println();
		System.out.println("\t\t{maxLat}");
		System.out.println("\t\t\tMaximum latitude URL subsitution variable");
		System.out.println();
