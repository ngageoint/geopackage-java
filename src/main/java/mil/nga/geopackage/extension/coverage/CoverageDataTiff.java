...
public class CoverageDataTiff extends CoverageDataCommon<CoverageDataTiffImage> {
	...
	/**
	 * Draw a coverage data image tile from the flat array of float pixel values
	 * of length tileWidth * tileHeight where each pixel is at: (y * tileWidth)
	 * + x
	 *
	 * @param pixelValues
	...
	/**
	 * Draw a coverage data image tile and format as TIFF bytes from the flat
	 * array of float pixel values of length tileWidth * tileHeight where each
	 * pixel is at: (y * tileWidth) + x
	 *
	 * @param pixelValues
	 *            float pixel values of length tileWidth * tileHeight
	 * @param tileWidth
	...
	public byte[] drawTileData(float[] pixelValues, int tileWidth,
			int tileHeight) {
		CoverageDataTiffImage image = drawTile(pixelValues, tileWidth,
				tileHeight);
	...
	/**
	 * Draw a coverage data image tile from the double array of float pixel
	...
	/**
	 * Draw a coverage data image tile from the flat array of coverage data of
	 * length tileWidth * tileHeight where each coverage data value is at: (y *
	 * tileWidth) + x
	 *
	 * @param griddedTile
	 *            gridded tile
	...
	/**
	 * Draw a coverage data image tile and format as TIFF bytes from the flat
	 * array of coverage data of length tileWidth * tileHeight where each
	...
	/**
	 * Draw a coverage data image tile from the double array of coverage data
	 * values formatted as Double[row][width]
	 *
	 * @param griddedTile
	 *            gridded tile
	 * @param values
